...
import com.zaihua.models.*;
import com.zaihua.models.base.DefaultContant;
import com.zaihua.models.base.FinmainindxComparator;
import com.zaihua.utils.JacksonUtils;
...
public class QuanjingbiaoService {
    ...
    public QuanjingbiaoService() {
        if (StringUtils.isBlank(COOKIE)) {
            COOKIE = DefaultContant.getXq_cookie();
        }
    }
